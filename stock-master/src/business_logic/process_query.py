...
from src.IO.get_data_from_yahoo import get_last_stock_price, get_last_stock_price2
...
def create_business_logic2():
    data_fetcher = get_last_stock_price2
    return BusinessLogic(Stock_model(data_fetcher))
...
class BusinessLogic:
    ...
    def __init__(self, model_creator):
        self._root_bucket = 'model_bucket_9876'
